...
private:
	...
	void subpx_gauss(const std::vector<double> &B_cut, struct FP B_max, struct FP B_min, double d_m, vector<double>& max_pos);
	void subpx_parabel(const std::vector<double> &B_cut, struct FP B_max, struct FP B_min, double d_m, vector<double>& max_pos);
